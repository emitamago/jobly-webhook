--
-- Credit to RIthm School. Main code is provided by one of school project.
...
--
-- Name: applications; Type: TABLE; Schema: public; Owner: emi
--
...
ALTER TABLE public.applications OWNER TO emi;

--
-- Name: companies; Type: TABLE; Schema: public; Owner: emi
--
...
ALTER TABLE public.companies OWNER TO emi;

--
-- Name: jobs; Type: TABLE; Schema: public; Owner: emi
--
...
ALTER TABLE public.jobs OWNER TO emi

--
-- Name: jobs_id_seq; Type: SEQUENCE; Schema: public; Owner: emi
--
...
ALTER TABLE public.jobs_id_seq OWNER TO emi;
...
ALTER TABLE public.users OWNER TO emi;

--
-- Name: jobs id; Type: DEFAULT; Schema: public; Owner: emi
--
